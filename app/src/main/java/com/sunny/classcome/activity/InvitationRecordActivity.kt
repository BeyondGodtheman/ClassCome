 ...
 * 邀约记录Activity
 */
class InvitationRecordActivity: BaseActivity() {
    ...
    override fun initView() {
        showTitle(titleManager.defaultTitle(getString(R.string.invitation_record)))
    ...
    override fun loadData() {
        ...
        ApiManager.post(composites, params, Constant.COURSE_GETUSERINVITECOURSE, object : ApiManager.OnResult<ClassBean>() {
