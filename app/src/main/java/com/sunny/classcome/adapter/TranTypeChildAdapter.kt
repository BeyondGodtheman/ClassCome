...
class TranTypeChildAdapter(list:ArrayList<ClassTypeBean.SubCategory>,var selectSet: HashSet<String>): BaseRecycleAdapter<ClassTypeBean.SubCategory>(list) {
    ...
    override fun onBindViewHolder(holder: BaseRecycleViewHolder, position: Int) {
        ...
        if (selectSet.contains(getData(position).name)){
