...
class ClassTypeChildAdapter(list:ArrayList<ClassTypeBean.SubCategory>,var selectMap:HashMap<String,ArrayList<ClassTypeBean.SubCategory>>,var pId:String): BaseRecycleAdapter<ClassTypeBean.SubCategory>(list) {
    ...
    override fun onBindViewHolder(holder: BaseRecycleViewHolder, position: Int) {
        ...
        if (selectMap[pId]?.contains(getData(position)) == true){
