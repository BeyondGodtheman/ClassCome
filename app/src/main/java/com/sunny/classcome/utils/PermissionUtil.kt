...
class PermissionUtil(private var activity: BaseActivity?) {
    ...
    fun cameraPermission(): Boolean {
        ...
        return requestPermission(Constant.CAMERA)
    }
    ...
    fun storagePermission(): Boolean {
        ...
        return requestPermission(Constant.STORAGE)
    }
    ...
    fun callPermission(): Boolean {
        ...
        return requestPermission(Constant.PHONE)
    }
    ...
    fun locationPermission(): Boolean {
        ...
        return requestPermission(Constant.LOCATION)
    }
    ...
    fun allPermission(): Boolean {
        permissions = arrayOf(
                ...
                Manifest.permission.CAMERA,
                Manifest.permission.ACCESS_COARSE_LOCATION)
        return requestPermission(Constant.ALL)
    }
